...
function Features() {
  return (
    <div className="features bg-dark text-white py-8 feature text-xl text-center">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {/* 24/7 Call Answering */}
        <div>
          <h5 className="text-light-aqua  font-bold mb-2">24/7 Call Answering</h5>
        ...
        <div>
         ...
         {/* AI-Powered Response */}
         <div>
          <h5 className="text-light-aqua  font-bold mb-2">AI-Powered Response</h5>
